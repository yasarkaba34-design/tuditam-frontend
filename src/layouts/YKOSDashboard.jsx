...
export default function YKOSDashboard({
  ...
  return (
    <div style={{ width: "100%", maxWidth: "1280px", margin: "0 auto", padding: "10px", color: "#ffffff", fontFamily: "Segoe UI, sans-serif" }}>
      ...
      {/* 1. ÜST BAR & TÜDİTAM KURUMSAL MÜHÜR */}
      <div style={{ ...cardStyle, paddingTop: "0px", position: "relative" }}>
        ...
        <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", marginTop: "10px", marginBottom: "8px" }}>
          <div style={{ margin: "0 0 6px 0", filter: "drop-shadow(0 0 16px rgba(245, 158, 11, 0.45))" }}>
            <img
              src="/tuditam-logo-yeni.png"
              alt="TÜDİTAM Logo"
              style={{ width: "260px", height: "auto", maxHeight: "220px", objectFit: "contain", display: "block", margin: "0 auto" }}
            />
          </div>

          <h1 style={{ color: "#f59e0b", fontSize: "2.4rem", fontWeight: "900", letterSpacing: "4px", margin: "0 0 4px 0", textShadow: "0 0 25px rgba(245, 158, 11, 0.5)" }}>
            TÜDİTAM
          </h1>

          <p style={{ color: "#94a3b8", fontSize: "0.85rem", letterSpacing: "1.5px", margin: 0, textTransform: "uppercase", fontWeight: "600" }}>
            TÜRK DİLİ VE TARİHİ ARAŞTIRMALARI MERKEZİ — YKOS BİLGİ SİSTEMİ
          </p>
        </div>
